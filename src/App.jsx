...
export default function App() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const now = new Date();
      const target = new Date(data.header.fechaISO);
  ...
  return (
    <div style={{ fontFamily: "'IBM Plex Sans', sans-serif", background: "#f4f2ee", minHeight: "100vh", color: "#1a1a1a" }}>
      ...
      {/* TOPBAR */}
      <div style={{ background: "#1a2744", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 48px", position: "sticky", top: 0, zIndex: 100 }}>
        <span style={{ fontFamily: "'Syne',sans-serif", fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: "rgba(255,255,255,0.5)" }}>Comité Ejecutivo · San Jerónimo de Tunán</span>
      ...
      <header style={{ background: "#1a2744", color: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ padding: "36px 48px 40px", position: "relative", zIndex: 1, textAlign: "center" }}>
          ...
          <h1 className="title1-anim" style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(28px,5vw,52px)", fontWeight: 800, lineHeight: 1.1, color: "#fff", marginBottom: 6 }}>
            {h.titulo1}
          </h1>
          <h1 className="title2-anim" style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(32px,6vw,62px)", fontWeight: 800, lineHeight: 1.1, color: "#c47b1a", marginBottom: 14 }}>
            {h.titulo2}
          </h1>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                {[["dias","días"],["horas","horas"],["min","min"],["seg","seg"]].map(([key, label], i) => (
                  <div key={key} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <div style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)", padding: "12px 18px", textAlign: "center", minWidth: 72, backdropFilter: "blur(4px)" }}>
                      <span style={{ display: "block", fontFamily: "'Syne',sans-serif", fontSize: 32, fontWeight: 800, color: "#fff", lineHeight: 1 }}>
                        {String(countdown[key] ?? "--").padStart(2, "0")}
                      </span>
                      <span style={{ display: "block", fontFamily: "'Syne',sans-serif", fontSize: 9, letterSpacing: 2, textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginTop: 4 }}>{label}</span>
                    </div>
                    {i < 3 && <span style={{ fontFamily: "'Syne',sans-serif", fontSize: 28, fontWeight: 700, color: "#c47b1a", marginBottom: 14 }}>:</span>}
                  </div>
                ))}
              </div>
            )}
      ...
      {/* ALERT BANNER */}
      <div style={{ background: "#c47b1a", padding: "18px 48px", display: "flex", alignItems: "flex-start", gap: 20 }}>
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: 48 }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 14, marginBottom: 28, paddingBottom: 12, borderBottom: "2px solid #1a2744" }}>
      ...
      <footer style={{ background: "#1a2744", color: "rgba(255,255,255,0.4)", marginTop: 48, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ textAlign: "center", padding: "20px 48px", fontSize: 11, letterSpacing: 1, borderTop: "1px solid rgba(255,255,255,0.08)" }}>
      ...
      {panel && (
        <div onClick={e => e.target === e.currentTarget && closePanel()} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 500, display: "flex", alignItems: "flex-start", justifyContent: "flex-end" }}>
          <div style={{ background: "#fff", width: 540, height: "100vh", overflowY: "auto", borderLeft: "3px solid #c47b1a", display: "flex", flexDirection: "column" }}>
